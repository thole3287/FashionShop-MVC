                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach ($products as $key => $product)
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-5">{{ number_format($endPrice) }} đồng</td>
                                            <td class="p-r-15">
                            ...
                            <div class="flex-w flex-t bor12 p-t-10 p-b-30">
                                ...
                                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                    <div class="p-t-5">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <textarea class="stext-111 cl8 plh3 size-111 p-lr-15" name="content" placeholder="Note for order"></textarea>
                                        </div>
